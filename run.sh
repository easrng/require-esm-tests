...
pnpm webpack --entry ./tests/index.cjs -o webpacked && node webpacked/main.js >./results/webpack.txt; rm -rf webpacked
pnpm rspack --entry ./tests/index.cjs -o rspacked && node rspacked/main.js >./results/rspack.txt; rm -rf rspacked
